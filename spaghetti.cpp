...
void loop()
{
    ...
    analogWrite(R, 255); // Encendido del led
    analogWrite(G, 255); // RGB en el color blanco
    analogWrite(B, 255);
    ...
    { // Detecta si se encuentra una persona
        ...
        analogWrite(R, 255);
        analogWrite(G, 255); // Enciende el led RGB de color amarillo
        analogWrite(B, 0);
        ...
        {   // Pregunta si esta distancia es menor o
            ...
            {   // Pregunta si esta temperatura es mayor o
                ...
                analogWrite(R, 255);
                analogWrite(G, 0); // Si es asi, enciende el led RGB en rojo
                analogWrite(B, 0);
            ...
            { // De lo contrario, si es menor a 37.5 grados
                ...
                analogWrite(R, 0);
                analogWrite(G, 255); // Enciende el led RGB en verde
                analogWrite(B, 0);
